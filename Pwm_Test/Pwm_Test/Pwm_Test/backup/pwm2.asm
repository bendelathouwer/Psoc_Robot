...
;  Global Symbols
;-----------------------------------------------
export  PWM2_EnableInt
export _PWM2_EnableInt
export  PWM2_DisableInt
export _PWM2_DisableInt
export  PWM2_Start
export _PWM2_Start
export  PWM2_Stop
export _PWM2_Stop
export  PWM2_WritePeriod
export _PWM2_WritePeriod
export  PWM2_WritePulseWidth
export _PWM2_WritePulseWidth
export  PWM2_wReadPulseWidth
export _PWM2_wReadPulseWidth
export  PWM2_wReadCounter
export _PWM2_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wPWM2_ReadPulseWidth    ; deprecated
export _wPWM2_ReadPulseWidth    ; deprecated
export  wPWM2_ReadCounter       ; deprecated
export _wPWM2_ReadCounter       ; deprecated


AREA pwm_test_RAM (RAM,REL)
...
_PWM2_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM2_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[PWM2_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM2_WritePulseWidth
;
;  DESCRIPTION:
...
_PWM2_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM2_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[PWM2_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM2_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM2_wReadPulseWidth:
_PWM2_wReadPulseWidth:
 wPWM2_ReadPulseWidth:                           ; this name deprecated
_wPWM2_ReadPulseWidth:                           ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM2_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[PWM2_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM2_wReadCounter
;
;  DESCRIPTION:
...
;
 PWM2_wReadCounter:
_PWM2_wReadCounter:
 wPWM2_ReadCounter:                              ; this name deprecated
_wPWM2_ReadCounter:                              ; this name deprecated
   ...
   mov   A, reg[PWM2_COMPARE_MSB_REG]            ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[PWM2_COMPARE_LSB_REG]            ;
   push  A                                          ;  -stack frame now 2 bytes-
   PWM2_Stop_M                                   ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[PWM2_INPUT_LSB_REG]              ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[PWM2_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[PWM2_COUNTER_MSB_REG]            ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[PWM2_COMPARE_MSB_REG]            ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[PWM2_COUNTER_LSB_REG]            ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[PWM2_COMPARE_LSB_REG]            ; Stash the Count LSB on the stack
   ...
   mov   reg[PWM2_INPUT_LSB_REG], A              ;    and restore it
   M8C_SetBank0                                     ;
   PWM2_Start_M                                  ; Now re-enable the PWM function
