...
;  Global Symbols
;-----------------------------------------------
export  Timer3_EnableInt
export _Timer3_EnableInt
export  Timer3_DisableInt
export _Timer3_DisableInt
export  Timer3_Start
export _Timer3_Start
export  Timer3_Stop
export _Timer3_Stop
export  Timer3_WritePeriod
export _Timer3_WritePeriod
export  Timer3_WriteCompareValue
export _Timer3_WriteCompareValue
export  Timer3_wReadCompareValue
export _Timer3_wReadCompareValue
export  Timer3_wReadTimer
export _Timer3_wReadTimer
export  Timer3_wReadTimerSaveCV
export _Timer3_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTimer3_ReadCompareValue  ; deprecated
export _wTimer3_ReadCompareValue  ; deprecated
export  wTimer3_ReadTimer         ; deprecated
export _wTimer3_ReadTimer         ; deprecated
export  wTimer3_ReadTimerSaveCV   ; deprecated
export _wTimer3_ReadTimerSaveCV   ; deprecated

export  wTimer3_ReadCounter       ; obsolete
export _wTimer3_ReadCounter       ; obsolete
export  wTimer3_CaptureCounter    ; obsolete
export _wTimer3_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer3_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer3_DisableInt
;
;  DESCRIPTION:
...
_Timer3_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer3_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Timer3_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer3_WriteCompareValue:
_Timer3_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer3_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Timer3_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer3_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer3_wReadCompareValue:
_Timer3_wReadCompareValue:
 wTimer3_ReadCompareValue:                       ; this name deprecated
_wTimer3_ReadCompareValue:                       ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer3_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Timer3_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer3_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer3_wReadTimerSaveCV:
_Timer3_wReadTimerSaveCV:
 wTimer3_ReadTimerSaveCV:                        ; this name deprecated
_wTimer3_ReadTimerSaveCV:                        ; this name deprecated
 wTimer3_ReadCounter:                            ; this name deprecated
_wTimer3_ReadCounter:                            ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[Timer3_CONTROL_LSB_REG]          ; save the Control register
   push  A
   mov   A, reg[Timer3_COMPARE_LSB_REG]          ; save the Compare register
   push  A
   mov   A, reg[Timer3_COMPARE_MSB_REG]
   push  A
   mov   A, reg[Timer3_COUNTER_LSB_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer3_COMPARE_MSB_REG]          ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[Timer3_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer3_wReadTimer
;
;  DESCRIPTION:
...
;
 Timer3_wReadTimer:
_Timer3_wReadTimer:
 wTimer3_ReadTimer:                              ; this name deprecated
_wTimer3_ReadTimer:                              ; this name deprecated
 wTimer3_CaptureCounter:                         ; this name deprecated
_wTimer3_CaptureCounter:                         ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer3_COUNTER_LSB_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[Timer3_COMPARE_MSB_REG]          ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[Timer3_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
