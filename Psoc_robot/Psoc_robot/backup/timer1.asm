...
;  Global Symbols
;-----------------------------------------------
export  Timer1_EnableInt
export _Timer1_EnableInt
export  Timer1_DisableInt
export _Timer1_DisableInt
export  Timer1_Start
export _Timer1_Start
export  Timer1_Stop
export _Timer1_Stop
export  Timer1_WritePeriod
export _Timer1_WritePeriod
export  Timer1_WriteCompareValue
export _Timer1_WriteCompareValue
export  Timer1_wReadCompareValue
export _Timer1_wReadCompareValue
export  Timer1_wReadTimer
export _Timer1_wReadTimer
export  Timer1_wReadTimerSaveCV
export _Timer1_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTimer1_ReadCompareValue  ; deprecated
export _wTimer1_ReadCompareValue  ; deprecated
export  wTimer1_ReadTimer         ; deprecated
export _wTimer1_ReadTimer         ; deprecated
export  wTimer1_ReadTimerSaveCV   ; deprecated
export _wTimer1_ReadTimerSaveCV   ; deprecated

export  wTimer1_ReadCounter       ; obsolete
export _wTimer1_ReadCounter       ; obsolete
export  wTimer1_CaptureCounter    ; obsolete
export _wTimer1_CaptureCounter    ; obsolete
...
_Timer1_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer1_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Timer1_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer1_WriteCompareValue:
_Timer1_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer1_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Timer1_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer1_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer1_wReadCompareValue:
_Timer1_wReadCompareValue:
 wTimer1_ReadCompareValue:                       ; this name deprecated
_wTimer1_ReadCompareValue:                       ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer1_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Timer1_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer1_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer1_wReadTimerSaveCV:
_Timer1_wReadTimerSaveCV:
 wTimer1_ReadTimerSaveCV:                        ; this name deprecated
_wTimer1_ReadTimerSaveCV:                        ; this name deprecated
 wTimer1_ReadCounter:                            ; this name deprecated
_wTimer1_ReadCounter:                            ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[Timer1_CONTROL_LSB_REG]          ; save the Control register
   push  A
   mov   A, reg[Timer1_COMPARE_LSB_REG]          ; save the Compare register
   push  A
   mov   A, reg[Timer1_COMPARE_MSB_REG]
   push  A
   mov   A, reg[Timer1_COUNTER_LSB_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer1_COMPARE_MSB_REG]          ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[Timer1_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer1_wReadTimer
;
;  DESCRIPTION:
...
;
 Timer1_wReadTimer:
_Timer1_wReadTimer:
 wTimer1_ReadTimer:                              ; this name deprecated
_wTimer1_ReadTimer:                              ; this name deprecated
 wTimer1_CaptureCounter:                         ; this name deprecated
_wTimer1_CaptureCounter:                         ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer1_COUNTER_LSB_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[Timer1_COMPARE_MSB_REG]          ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[Timer1_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
