...
export LoadConfig_pulstest
export _LoadConfig_pulstest
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_pulstest
	lcall	LoadConfigTBL_pulstest_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration pulstest
;
;    Load configuration registers for pulstest.
...
_LoadConfig_pulstest:
 LoadConfig_pulstest:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_pulstest_Bank0
    mov     X, <LoadConfigTBL_pulstest_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_pulstest_Bank1
    mov     X, <LoadConfigTBL_pulstest_Bank1
