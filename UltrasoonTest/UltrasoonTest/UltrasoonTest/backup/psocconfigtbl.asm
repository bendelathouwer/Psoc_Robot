...
export LoadConfigTBL_ultrasoontest_Bank1
export LoadConfigTBL_ultrasoontest_Bank0
export LoadConfigTBL_ultrasoontest_Ordered
AREA lit(rom, rel)
LoadConfigTBL_ultrasoontest_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_ultrasoontest_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name Timer, User Module Timer16
;       Instance name Timer, Block Name TIMER16_LSB(DBB00)
...
LoadConfigTBL_ultrasoontest_Ordered:
