...
export LoadConfigTBL_pulstest_Bank1
export LoadConfigTBL_pulstest_Bank0
export LoadConfigTBL_pulstest_Ordered
AREA lit(rom, rel)
LoadConfigTBL_pulstest_Bank0:
...
LoadConfigTBL_pulstest_Ordered:
