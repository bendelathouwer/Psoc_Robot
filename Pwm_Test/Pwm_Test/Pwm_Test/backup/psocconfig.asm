...
;---------------------------------------------------------------------------
; Load Configuration pwm_test
;
;    Load configuration registers for pwm_test.
...
_LoadConfig_pwm_test:
 LoadConfig_pwm_test:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_pwm_test_Bank0
    mov     X, <LoadConfigTBL_pwm_test_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_pwm_test_Bank1
    mov     X, <LoadConfigTBL_pwm_test_Bank1
