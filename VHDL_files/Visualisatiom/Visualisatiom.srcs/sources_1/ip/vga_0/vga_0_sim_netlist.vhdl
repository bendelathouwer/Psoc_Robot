...
--               c:/Users/Ben/Documents/GitHub/Psoc_robot/VHDL_files/Visualisatiom/Visualisatiom.srcs/sources_1/ip/vga_0/vga_0_sim_netlist.vhdl
-- Design      : vga_0
...
architecture STRUCTURE of vga_0_vga is
  ...
  attribute SOFT_HLUTNM of \h_cnt[6]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \h_cnt[7]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \h_cnt[8]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \h_cnt[9]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of hsync_i_i_3 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \line_cnt[10]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \line_cnt[10]_i_5\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \line_cnt[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \line_cnt[4]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \line_cnt[6]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \line_cnt[7]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \line_cnt[8]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \line_cnt[9]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \pixel_cnt[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \pixel_cnt[10]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \pixel_cnt[10]_i_4\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \pixel_cnt[1]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \pixel_cnt[4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \pixel_cnt[7]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \pixel_cnt[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \pixel_cnt[9]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \v_cnt[0]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \v_cnt[1]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \v_cnt[2]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \v_cnt[3]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of valid_INST_0 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of vsync_i_i_3 : label is "soft_lutpair9";
begin
...
hsync_i_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\line_cnt[10]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\pixel_cnt[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
vsync_i_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFF8F"
    )
        port map (
...
vsync_i_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
entity vga_0 is
  ...
  attribute CORE_GENERATION_INFO of vga_0 : entity is "vga_0,vga,{x_ipProduct=Vivado 2015.4,x_ipVendor=xilinx.com,x_ipLibrary=XUP,x_ipName=vga,x_ipVersion=1.0,x_ipCoreRevision=16,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,TYPE=0}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of vga_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of vga_0 : entity is "vga,Vivado 2015.4";
end vga_0;
