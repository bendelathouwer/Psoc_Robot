...
export LoadConfig_ultrasoontest
export _LoadConfig_ultrasoontest
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_ultrasoontest
	lcall	LoadConfigTBL_ultrasoontest_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration ultrasoontest
;
;    Load configuration registers for ultrasoontest.
...
;               CUR_PP
;
_LoadConfig_ultrasoontest:
 LoadConfig_ultrasoontest:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_ultrasoontest_Bank0
    mov     X, <LoadConfigTBL_ultrasoontest_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_ultrasoontest_Bank1
    mov     X, <LoadConfigTBL_ultrasoontest_Bank1
