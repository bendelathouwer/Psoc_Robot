...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../Visualisatiom.srcs/sources_1/ip/vga_0/vga_0_sim_netlist.vhdl" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.vga_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.vga_0 -input simulate.do
}
# Script usage
usage()
{
