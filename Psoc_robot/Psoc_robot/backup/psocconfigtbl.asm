...
;       Instance name PWM, Block Name PWM16_LSB(DCB02)
	db		2bh, 00h		;PWM_CONTROL_LSB_REG(DCB02CR0)
	db		29h, 00h		;PWM_PERIOD_LSB_REG(DCB02DR1)
	db		2ah, e8h		;PWM_COMPARE_LSB_REG(DCB02DR2)
;       Instance name PWM, Block Name PWM16_MSB(DCB03)
	db		2fh, 00h		;PWM_CONTROL_MSB_REG(DCB03CR0)
	db		2dh, 00h		;PWM_PERIOD_MSB_REG(DCB03DR1)
	db		2eh, 03h		;PWM_COMPARE_MSB_REG(DCB03DR2)
...
;  Instance name PWM, User Module PWM16
;       Instance name PWM, Block Name PWM16_LSB(DCB02)
	db		28h, 11h		;PWM_FUNC_LSB_REG(DCB02FN)
	db		29h, 16h		;PWM_INPUT_LSB_REG(DCB02IN)
	db		2ah, 40h		;PWM_OUTPUT_LSB_REG(DCB02OU)
;       Instance name PWM, Block Name PWM16_MSB(DCB03)
	db		2ch, 31h		;PWM_FUNC_MSB_REG(DCB03FN)
	db		2dh, 36h		;PWM_INPUT_MSB_REG(DCB03IN)
	db		2eh, 45h		;PWM_OUTPUT_MSB_REG(DCB03OU)
;  Instance name Timer, User Module Timer16
;       Instance name Timer, Block Name TIMER16_LSB(DBB00)
	db		20h, 00h		;Timer_FUNC_LSB_REG(DBB00FN)
	db		21h, e6h		;Timer_INPUT_LSB_REG(DBB00IN)
