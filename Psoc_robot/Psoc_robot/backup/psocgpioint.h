...
******************************************************************************/
#include <m8c.h>
// reciever_In address and mask defines
#pragma	ioport	reciever_In_Data_ADDR:	0x0
BYTE			reciever_In_Data_ADDR;
#pragma	ioport	reciever_In_DriveMode_0_ADDR:	0x100
BYTE			reciever_In_DriveMode_0_ADDR;
#pragma	ioport	reciever_In_DriveMode_1_ADDR:	0x101
BYTE			reciever_In_DriveMode_1_ADDR;
#pragma	ioport	reciever_In_DriveMode_2_ADDR:	0x3
BYTE			reciever_In_DriveMode_2_ADDR;
#pragma	ioport	reciever_In_GlobalSelect_ADDR:	0x2
BYTE			reciever_In_GlobalSelect_ADDR;
#pragma	ioport	reciever_In_IntCtrl_0_ADDR:	0x102
BYTE			reciever_In_IntCtrl_0_ADDR;
#pragma	ioport	reciever_In_IntCtrl_1_ADDR:	0x103
BYTE			reciever_In_IntCtrl_1_ADDR;
#pragma	ioport	reciever_In_IntEn_ADDR:	0x1
BYTE			reciever_In_IntEn_ADDR;
#define reciever_In_MASK 0x4
