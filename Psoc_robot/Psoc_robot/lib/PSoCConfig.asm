...
export LoadConfig_psoc_robot
export _LoadConfig_psoc_robot
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_psoc_robot
	lcall	LoadConfigTBL_psoc_robot_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration psoc_robot
;
;    Load configuration registers for psoc_robot.
...
;               CUR_PP
;
_LoadConfig_psoc_robot:
 LoadConfig_psoc_robot:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_psoc_robot_Bank0
    mov     X, <LoadConfigTBL_psoc_robot_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_psoc_robot_Bank1
    mov     X, <LoadConfigTBL_psoc_robot_Bank1
